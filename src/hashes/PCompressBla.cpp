...
Registry<PCompressBla> regpcb;

PCompressBla::PCompressBla()
:Registerable("PCompressBla", "PCB", 
	"P Compress with BlaMka")
{}

void
PCompressBla::ResetState()
{}
...
void
PCompressBla::Hash(int vindex, const uint8_t* i1, const uint8_t* i2, 
            uint8_t* hash)
{
    __m128i v[8];
    __m128i t0, t1;
...
uint16_t
PCompressBla::getHlenFast()const{
  return H_LEN_FAST;
}